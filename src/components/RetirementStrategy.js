...
const RetirementStrategy = () => {
  ...
  return (
    ...
    <div className="relative top-40 p-4 h-fit bg-zinc-100 rounded-2xl flex flex-col gap-2 sm:top-8 sm:left-[75%] sm:block sm:w-[20%]">
      ...
      <div className="flex justify-between my-2 sm:flex-col lg:flex-row">
        <div className="w-3/4 text-sm">Employer Contribution</div>
        <div className="w-1/4 flex justify-center items-center">8.4%</div>
      </div>
      <div className="flex justify-between my-2 pb-2 sm:pb-0 sm:flex-col lg:flex-row">
      ...
      <div className="hidden sm:block">
        ...
        <div className="flex underline justify-center text-sm text-blue-700 hover:cursor-pointer">
          View Help Docs{">"}
        </div>
        
      </div>
      <div className=" sm:mt-4 lg: mt-8 ">
            <h5 className=" text-zinc-700">Are you considering a</h5>
            <h4 style={{ marginTop: "0" }}>Housing Advance</h4>
            <p className="text-zinc-500 text-sm">Limited time reduced interest</p>
            <p className=" text-sm"style={{ color: "#4433FF" }}>Learn More ></p>
          </div>
    </div>
